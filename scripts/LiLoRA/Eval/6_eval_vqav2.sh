...
bash "$DIR/eval_task.sh" 5 model_vqa_cc_instruction VQAv2/val.json VQAv2_single "$MODEL_PATH" "$RESULT_DIR" "$GPUS" "$INSTRUCTION_ROOT" "$IMAGE_FOLDER" "$MODEL_BASE" "$MM_PRETRAIN_PROJECTOR"
