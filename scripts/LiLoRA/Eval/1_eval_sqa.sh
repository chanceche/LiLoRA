...
bash "$DIR/eval_task.sh" 0 model_vqa_science ScienceQA/test.json ScienceQA_single "$MODEL_PATH" "$RESULT_DIR" "$GPUS" "$INSTRUCTION_ROOT" "$IMAGE_FOLDER" "$MODEL_BASE" "$MM_PRETRAIN_PROJECTOR"
