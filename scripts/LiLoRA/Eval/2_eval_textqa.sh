...
bash "$DIR/eval_task.sh" 1 model_text_vqa TextVQA/val.json TextVQA_single "$MODEL_PATH" "$RESULT_DIR" "$GPUS" "$INSTRUCTION_ROOT" "$IMAGE_FOLDER" "$MODEL_BASE" "$MM_PRETRAIN_PROJECTOR"
