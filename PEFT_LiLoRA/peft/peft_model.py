...
dispatch_model = infer_auto_device_map = get_balanced_memory = None
AlignDevicesHook = add_hook_to_module = remove_hook_from_submodules = None
...
def _require_accelerate():
    global dispatch_model, infer_auto_device_map, get_balanced_memory
    global AlignDevicesHook, add_hook_to_module, remove_hook_from_submodules

    if dispatch_model is not None:
        return

    from accelerate import dispatch_model as _dispatch_model, infer_auto_device_map as _infer_auto_device_map
    from accelerate.hooks import (
        AlignDevicesHook as _AlignDevicesHook,
        add_hook_to_module as _add_hook_to_module,
        remove_hook_from_submodules as _remove_hook_from_submodules,
    )
    from accelerate.utils import get_balanced_memory as _get_balanced_memory

    dispatch_model = _dispatch_model
    infer_auto_device_map = _infer_auto_device_map
    get_balanced_memory = _get_balanced_memory
    AlignDevicesHook = _AlignDevicesHook
    add_hook_to_module = _add_hook_to_module
    remove_hook_from_submodules = _remove_hook_from_submodules
