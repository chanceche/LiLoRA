...
def get_peft_model_state_dict(model, state_dict=None, adapter_name="default"):
    ...
    if config.peft_type in (PeftType.LORA, PeftType.ADALORA, PeftType.LILORA):
...
def set_peft_model_state_dict(model, peft_model_state_dict, adapter_name="default"):
    ...
    if config.peft_type in (PeftType.LORA, PeftType.ADALORA, PeftType.IA3, PeftType.LILORA):
