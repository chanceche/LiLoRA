...
from llava.train.llava_trainer import LLaVATrainer, LLaVA_EWC_Trainer
...
def train():
    ...
    if training_args.lora_enable:
        ...
        rank0_print(find_all_linear_names(model))
    ...
    if model_args.vision_tower is not None:
        model.get_model().initialize_vision_modules(           #先初始化视觉模块
    ...
    trainer = LLaVATrainer(model=model,
                    ...
                    args=training_args,
                    **data_module)
    # trainer = LLaVA_EWC_Trainer(model=model,
    #                 tokenizer=tokenizer,
    #                 args=training_args,
    #                 **data_module)
