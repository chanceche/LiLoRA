...
def eval_model(args):
    ...
    for (input_ids, image_tensor), line in tqdm(zip(data_loader, questions), total=len(questions)):
        ...
        cur_prompt = "USER: " + cur_prompt + " ASSISTANT: <s>"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="checkpoints/Instruction_single_type/1_TextVQA_llava_v1.5_lilora_7b")
    parser.add_argument("--model-base", type=str, default="models/vicuna-7b-v1.5")
    parser.add_argument("--task-id", type=int, default=0)
    parser.add_argument("--image-folder", type=str, default="data/datasets")
    parser.add_argument("--question-file", type=str, default="data/CVIT_benchmark/Instructions_Single/TextVQA/val.json")
