...
def get_args():
    ...
    parser.add_argument('--base-dir', type=str, default='data/datasets/ScienceQA')
    parser.add_argument('--result-file', type=str, default='results/Instruction_single_type/ScienceQA/0_ScienceQA_llava_v1.5_lilora_7b/merge.jsonl')
    parser.add_argument('--output-file', type=str, default='results/Instruction_single_type/ScienceQA/0_ScienceQA_llava_v1.5_lilora_7b/output.jsonl')
