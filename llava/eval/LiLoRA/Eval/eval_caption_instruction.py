...
def get_args():
    ...
    parser.add_argument('--result-file', type=str, default='results/Instruction_single_type/Flickr30k/2_Flickr30k_llava_v1.5_lilora_7b/merge.jsonl')
    parser.add_argument('--output-file', type=str, default='results/Instruction_single_type/Flickr30k/2_Flickr30k_llava_v1.5_lilora_7b/output.jsonl')
