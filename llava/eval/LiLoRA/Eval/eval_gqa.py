...
parser.add_argument('--annotation-dir', type=str, default='data/datasets/GQA')
...
questions = loadFile(os.path.join(args.annotation_dir,args.questions.format(tier = args.tier)))
